...
struct VideoPlaybackView: View {
    ...
    @State private var playerMonitor: VideoPlayerMetricMonitor?
    ...
    private func setupPlayer(with url: URL) {
        ...
        do {
            try playerMonitor = VideoPlayerMetricMonitor(player: player)
        } catch let error {
            print("failed to setup VideoPlayerMetricMonitor: \(error)")
            return
        }
        playerMonitor!.startReporting()
        player.play()
